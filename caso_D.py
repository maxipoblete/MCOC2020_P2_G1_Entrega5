...
def caso_D():
    ...
    props_elevacion_cruzadas = [8*cm, 2*mm, 200*GPa, 7600*kg/m**3, 420*MPa]
    
    props_elevacion_longitudinales = [5.5*cm, 2*mm, 200*GPa, 7600*kg/m**3, 420*MPa]

    props_elevacion_verticales = [5.3*cm, 1*mm, 200*GPa, 7600*kg/m**3, 420*MPa]

    props_tablero_inferior_cruzadas = [8*cm, 3*mm, 200*GPa, 7600*kg/m**3, 420*MPa]
    props_tablero_superiores_cruzadas = [6.9*cm, 3*mm, 200*GPa, 7600*kg/m**3, 420*MPa]
    
    
    
    props_tablero_inferior_horizontales =   [8*cm, 1*mm, 200*GPa, 7600*kg/m**3, 420*MPa]
    props_tablero_superiores_horizontales = [5.5*cm, 1*mm, 200*GPa, 7600*kg/m**3, 420*MPa]
